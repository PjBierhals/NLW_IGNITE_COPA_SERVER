/*
  ...
  - You are about to drop the column `secoundTeamCountryCode` on the `Game` table. All the data in the column will be lost.
  - You are about to drop the column `firstTeamCountryPoints` on the `Guess` table. All the data in the column will be lost.
  - You are about to drop the column `secoundTeamCountryPoints` on the `Guess` table. All the data in the column will be lost.
